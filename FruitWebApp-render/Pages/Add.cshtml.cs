...
namespace FruitWebApp.Pages
{
  public class AddModel : PageModel
  {
    ...
    [BindProperty]
    public NetworkClientModel networkClientModels { get; set; }

    // Begin POST operation code
    public async Task<IActionResult> OnPost()
    {
      // Serialize the information to be added to the database
      var jsonContent = new StringContent(JsonSerializer.Serialize(networkClientModels),
          Encoding.UTF8,
          "application/json");
      ...
      Console.WriteLine($"NetworkClients POST JSON content : {jsonContent.ReadAsStringAsync().Result}");
